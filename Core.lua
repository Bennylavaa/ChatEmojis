...
function addon:SetupDefaultEmojis()
    ...
    self:AddSmiley(":kappa:", self:TextureString(M..[[Emojis\Kappa.tga]], x))
    self:AddSmiley(":meaw:", self:TextureString(M..[[Emojis\Meaw.tga]], x))
    self:AddSmiley(":middle_finger:", self:TextureString(M..[[Emojis\MiddleFinger.tga]], x))
    self:AddSmiley(":murloc:", self:TextureString(M..[[Emojis\Murloc.tga]], x))
    ...
    self:AddSmiley(":sadkitty:", self:TextureString(M..[[Emojis\SadKitty.tga]], x))
    ...
    -- Epoch Emojis
    self:AddSmiley(":alliance:", self:TextureString(M..[[EpochEmojis\Alliance.tga]], x))
    self:AddSmiley(":disenchant:", self:TextureString(M..[[EpochEmojis\Disenchant.tga]], x))
    self:AddSmiley(":druid:", self:TextureString(M..[[EpochEmojis\Druid.tga]], x))
    self:AddSmiley(":epog:", self:TextureString(M..[[EpochEmojis\Epog.tga]], x))
    self:AddSmiley(":feelshordeman:", self:TextureString(M..[[EpochEmojis\FeelsHordeMan.tga]], x))
    self:AddSmiley(":femaledwarf:", self:TextureString(M..[[EpochEmojis\FemaleDwarf.tga]], x))
    self:AddSmiley(":femalegnome:", self:TextureString(M..[[EpochEmojis\FemaleGnome.tga]], x))
    self:AddSmiley(":femalehuman:", self:TextureString(M..[[EpochEmojis\FemaleHuman.tga]], x))
    self:AddSmiley(":femalenightelf:", self:TextureString(M..[[EpochEmojis\FemaleNightelf.tga]], x))
    self:AddSmiley(":femaleorc:", self:TextureString(M..[[EpochEmojis\FemaleOrc.tga]], x))
    self:AddSmiley(":femaletauren:", self:TextureString(M..[[EpochEmojis\FemaleTauren.tga]], x))
    self:AddSmiley(":femaletroll:", self:TextureString(M..[[EpochEmojis\FemaleTroll.tga]], x))
    self:AddSmiley(":femaleundead:", self:TextureString(M..[[EpochEmojis\FemaleUndead.tga]], x))
    self:AddSmiley(":gryphon:", self:TextureString(M..[[EpochEmojis\Gryphon.tga]], x))
    self:AddSmiley(":hogger:", self:TextureString(M..[[EpochEmojis\Hogger.tga]], x))
    self:AddSmiley(":horde:", self:TextureString(M..[[EpochEmojis\Horde.tga]], x))
    self:AddSmiley(":hunter:", self:TextureString(M..[[EpochEmojis\Hunter.tga]], x))
    self:AddSmiley(":kekdwarf:", self:TextureString(M..[[EpochEmojis\KekDwarf.tga]], x))
    self:AddSmiley(":mage:", self:TextureString(M..[[EpochEmojis\Mage.tga]], x))
    self:AddSmiley(":maledwarf:", self:TextureString(M..[[EpochEmojis\MaleDwarf.tga]], x))
    self:AddSmiley(":malegnome:", self:TextureString(M..[[EpochEmojis\MaleGnome.tga]], x))
    self:AddSmiley(":malehuman:", self:TextureString(M..[[EpochEmojis\MaleHuman.tga]], x))
    self:AddSmiley(":malenightelf:", self:TextureString(M..[[EpochEmojis\MaleNightelf.tga]], x))
    self:AddSmiley(":malenightelf2:", self:TextureString(M..[[EpochEmojis\MaleNightelf2.tga]], x))
    self:AddSmiley(":maleorc:", self:TextureString(M..[[EpochEmojis\MaleOrc.tga]], x))
    self:AddSmiley(":maletauren:", self:TextureString(M..[[EpochEmojis\MaleTauren.tga]], x))
    self:AddSmiley(":maletroll:", self:TextureString(M..[[EpochEmojis\MaleTroll.tga]], x))
    self:AddSmiley(":maleundead:", self:TextureString(M..[[EpochEmojis\MaleUndead.tga]], x))
    self:AddSmiley(":metzen:", self:TextureString(M..[[EpochEmojis\Metzen.tga]], x))
    self:AddSmiley(":moonkin:", self:TextureString(M..[[EpochEmojis\Moonkin.tga]], x))
    self:AddSmiley(":omegawow:", self:TextureString(M..[[EpochEmojis\Omegawow.tga]], x))
    self:AddSmiley(":paladin:", self:TextureString(M..[[EpochEmojis\Paladin.tga]], x))
    self:AddSmiley(":priest:", self:TextureString(M..[[EpochEmojis\Priest.tga]], x))
    self:AddSmiley(":rogue:", self:TextureString(M..[[EpochEmojis\Rogue.tga]], x))
    self:AddSmiley(":samwise:", self:TextureString(M..[[EpochEmojis\Samwise.tga]], x))
    self:AddSmiley(":shaman:", self:TextureString(M..[[EpochEmojis\Shaman.tga]], x))
    self:AddSmiley(":teldrachad:", self:TextureString(M..[[EpochEmojis\TeldraChad.tga]], x))
    self:AddSmiley(":uwutuskarr:", self:TextureString(M..[[EpochEmojis\UwuTuskarr.tga]], x))
    self:AddSmiley(":warcraft:", self:TextureString(M..[[EpochEmojis\Warcraft.tga]], x))
    self:AddSmiley(":warlock:", self:TextureString(M..[[EpochEmojis\Warlcok.tga]], x))
    self:AddSmiley(":warrior:", self:TextureString(M..[[EpochEmojis\Warrior.tga]], x))
